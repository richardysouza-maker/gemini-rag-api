#!/bin/bash
# ============================================================
# Script: update-prompt-v5.2.sh
# Atualiza o prompt v5.2 (anti-alucinação) no projeto NestJS
# ============================================================
set -e
...
echo "📝 Atualizando prompt para v5.2 (anti-alucinação)..."

# ============================================================
# Backup do prompt anterior
# ============================================================
if [ -f "src/modules/ai-chat/prompts/suporte-amei-v5.1.md" ]; then
  cp src/modules/ai-chat/prompts/suporte-amei-v5.1.md src/modules/ai-chat/prompts/suporte-amei-v5.1.md.bak
  echo "💾 Backup salvo: suporte-amei-v5.1.md.bak"
fi

# ============================================================
# Escrever o novo prompt v5.2
# ============================================================
cat > src/modules/ai-chat/prompts/suporte-amei-v5.2.md << 'PROMPT_EOF'
...
# Substituir o nome do arquivo carregado pelo serviço
if grep -q "suporte-amei-v5.1.md" src/modules/ai-chat/ai-chat.service.ts; then
  sed -i 's/suporte-amei-v5.1.md/suporte-amei-v5.2.md/g' src/modules/ai-chat/ai-chat.service.ts
  echo "✅ ai-chat.service.ts atualizado para carregar v5.2"
fi
...
echo "1. Reinicia o Nest (Ctrl+C no terminal dele e 'npm run start:dev')"
echo "2. Cria UMA NOVA CONVERSA no chat (importante - pra zerar contexto)"
echo "3. Testa de novo: 'estou sem acesso ao sistema, não consigo entrar, está dando senha inválida'"
echo ""
echo "Esperado agora:"
echo "  → 'Sobre acesso ao sistema, eu não tenho informação aqui na minha base...'"
echo "  → Inicia triagem com 1 pergunta por turno"
echo "  → Termina com intencao_imagem + intencao-operador"
